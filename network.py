...
from ops import random_bbox, bbox2mask, gan_wgan_loss, local_patch, gradients_penalty, random_interpolates, free_form_mask_tf, priority_loss_mask, id_mrf_reg
from util import f2uint, get_random_int
...
class GMCNNModel:
    ...
    def build_net(self, batch_data, config, summary=True, reuse=False):
        ...
        if config.mask_type == 'rect':
            ...
            synthesis = self.discriminator(interpolates_global, get_random_int())
