...
class ConfigOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--mode', type=str, default='silent')
        ...
        #                          help='dataset')
        # self.parser.add_argument('--data_file', type=str, default='./imgs/celebahq_512x512_rect', help='testing file paths')
        # self.parser.add_argument('--load_model_dir', type=str, default='./checkpoints/celebahq_512x512_rect', help='pretrained models')
        ...
        self.parser.add_argument('--g_cnum', type=int, default=32,
                                help='# of generator filters in first conv layer')
        self.parser.add_argument('--dataset', type=str, default='places2',
                                 help='dataset')
        self.parser.add_argument('--data_file', type=str, default='./imgs/places2_512x680_freeform', help='testing file paths')
        self.parser.add_argument('--load_model_dir', type=str, default='./checkpoints/places2_512x680_freeform', help='pretrained models')
